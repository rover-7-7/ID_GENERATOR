...
function fun() {
  var randimg1 = "background-color:  #02042b";
  document.querySelector("#l3").setAttribute("style", randimg1);

  var randimg1 = "background-color:  #8f94fb";
...
function generateIDCard() {
  ...
  reader.onload = function () {
    ...
    document.getElementById("l2").innerHTML = `
      ...
      <h4 style="position: absolute; color:aliceblue; left:160px; z-index: 100; top:40px;">Name: ${name}</h4>
      <h4 style="position: absolute; color:aliceblue; left:160px; z-index: 100; top:100px;">College Name: ${college}</h4>
      <h4 style="position: absolute; color:aliceblue; left:160px; z-index: 100; top:160px;">Location: ${location}</h4>
    `;
  };
